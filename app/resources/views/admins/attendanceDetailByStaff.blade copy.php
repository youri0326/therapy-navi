...
<body>
    ...
    <!-- staff_attendance_by_month.blade.php -->
    ...
    <div id="attendanceModal" class="modal">
       ...
       <!-- 登録・更新用のフォーム -->
        <form id="attendanceForm">
                ...
                <input type="text" name="work_hours" placeholder="Work Hours">
                <input type="text" name="attendance_status" placeholder="Attendance Status">
                <!-- 他のフォーム要素も追加 -->
    ...
    <!-- ポップアップを表示するボタン -->
    <button onclick="openModal()">Add/Update Attendance</button>

    <script>
    // staff_attendance_by_month.blade.php（JavaScript部分）
    function openModal() {
        var modal = document.getElementById('attendanceModal');
        modal.style.display = 'block';

        // ここにモーダル表示時の処理を追加してください
    }
